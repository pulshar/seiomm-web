...
export function AboutHero() {
  return (
    <section className="bg-[url('/images/bgs/degradado-full.png')] bg-cover bg-center bg-no-repeat pb-20 md:pb-28 lg:pb-32 pt-[calc(4.5rem+75px)] md:pt-[calc(6rem+75px)] lg:pt-[calc(8rem+75px)] border-b border-seiomm-8">
