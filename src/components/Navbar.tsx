    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 text-white group">
          <svg className={`transition-[width] duration-300 ${effectiveIsScrolled ? 'w-[120px]' : 'w-[120px] md:w-[150px]'}`} viewBox="0 0 150 72" fill="none" xmlns="http://www.w3.org/2000/svg">
