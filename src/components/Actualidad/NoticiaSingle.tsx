...
import { ArrowUpRight, ChevronLeft, Calendar, Tag, Share2, MoveLeft } from 'lucide-react';
import { Link } from 'react-router-dom';
import { MarqueeSection } from '../MarqueeSection';
import { JoinSectionDarkBg } from '../JoinSectionDarkBg';
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
                            ...
                            <div className="lg:col-span-8">
                                ...
                                {/* Footer / Share */}
                                <div className="mt-16 pt-8 border-t border-seiomm-dark/10 flex items-center justify-between gap-4">
