...
export function VentajasCta() {
  return (
    <section className="py-18 md:py-24 lg:py-32 bg-seiomm-darker border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
          ...
          <div className="max-w-2xl">
            ...
            >
              Forma parte de una comunidad que hace <span className="text-seiomm-cyan-on-dark">avanzar la salud ósea.</span>
            </motion.h2>
          </div>
          ...
          >
            <p className="text-white/80 text-base leading-relaxed">
              Profesionales de distintas disciplinas unidos por un objetivo común desde 1985. Tu sitio está aquí.
            </p>
