        ...
        >
          {advantages.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative p-6 md:p-10 lg:p-12 border-r border-b border-seiomm-10 flex flex-col justify-between transition-colors duration-300 hover:bg-seiomm-gray/50"
              >
                <div>
                  {/* Icon Circle */}
