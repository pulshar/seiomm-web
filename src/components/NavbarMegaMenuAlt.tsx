...
export interface TabConfig {
    id: 'seiomm' | 'profesionales' | 'pacientes';
    name: string;
    shortLabel: string;
    badge?: string;
    href: string;
    colorType: 'neutral' | 'blue' | 'green';
    accentColor: string;
    lightBg: string;
    borderColor: string;
    textColor: string;
...
export const navigationTabs: TabConfig[] = [
    {
        ...
        colorType: 'neutral',
        accentColor: '#0A1220',
        lightBg: 'bg-zinc-100/80',
        borderColor: 'border-seiomm-dark',
        textColor: 'text-seiomm-dark',
        icon: Building2,
        featured: {
            title: 'Conoce SEIOMM',
            desc: 'Sociedad Española de Investigación Ósea y del Metabolismo Mineral. Más de tres décadas impulsando la excelencia científica.',
            tag: 'Sobre nosotros',
            image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=600&auto=format&fit=crop',
            href: '/quienes-somos',
            ctaText: 'Descubrir la sociedad'
        },
        categories: [
            {
                title: 'La sociedad',
                icon: Users,
                links: [
                    { name: 'Junta directiva', href: '/quienes-somos', description: 'Órganos de gobierno y comités' },
                    { name: 'Estatutos y normativa', href: '/quienes-somos', description: 'Marco estatutario de la SEIOMM' },
                    { name: 'Representantes autonómicos', href: '/quienes-somos', description: 'Presencia territorial en España' },
                    { name: 'Comité científico', href: '/quienes-somos', description: 'Evaluación y rigor metodológico' }
                ]
            },
            {
                title: 'Fundación & grupos',
                icon: Sparkles,
                links: [
                    { name: 'Fundación FEIOMM', href: '/quienes-somos', description: 'Fomento de la investigación ósea' },
                    { name: 'Grupos de trabajo', href: '/quienes-somos', description: 'Líneas colaborativas especializadas' },
                    { name: 'Declaraciones de interés', href: '/quienes-somos', description: 'Aval científico oficial' },
                    { name: 'Nuestra historia', href: '/quienes-somos', description: 'Trayectoria y logros desde la fundación' }
                ]
            },
            {
                title: 'Comunidad & socios',
                icon: ShieldCheck,
                links: [
                    { name: 'Hazte socio', href: 'https://socios.seiomm.org/register', isExternal: true, description: 'Únete a nuestra comunidad científica' },
                    { name: 'Ventajas de ser miembro', href: '/quienes-somos', description: 'Acceso exclusivo a becas y eventos' },
                    { name: 'Área privada de socios', href: 'https://socios.seiomm.org/login', isExternal: true, description: 'Gestión de perfil y contenidos' },
                    { name: 'Contacto y sedes', href: '/quienes-somos', description: 'Secretaría técnica y consultas' }
                ]
            }
        ]
    },

    {
        ...
        badge: 'Científico & médico',
        href: '/congreso',
        colorType: 'blue',
        accentColor: '#01A0DA',
        lightBg: 'bg-sky-50',
        borderColor: 'border-[#01A0DA]',
        textColor: 'text-[#01A0DA]',
        icon: Stethoscope,
        featured: {
        ...
        categories: [
            ...
            },
            {
                ...
                icon: GraduationCap,
                links: [
                    { name: 'Congreso Nacional SEIOMM', href: '/congreso', description: 'El evento anual de referencia en España' },
                    { name: 'Cursos y talleres acreditados', href: '/congreso', description: 'Créditos de formación continua' },
                    { name: 'Ponencias y vídeos clínicos', href: '/congreso', description: 'Grabaciones de simposios y mesas' },
                    { name: 'Casos clínicos interactivos', href: '/actualidad', description: 'Discusión multidisciplinar entre especialistas' }
                ]
            },
            {
                title: 'Herramientas',
                icon: FileText,
                links: [
                    { name: 'Guías de práctica clínica', href: '/actualidad', description: 'Recomendaciones oficiales actualizadas' },
                    { name: 'Documentos de consenso', href: '/actualidad', description: 'Postura interdisciplinar de sociedades' },
                    { name: 'Calculadoras y escalas de riesgo', href: '/actualidad', description: 'Algoritmos diagnósticos y de fractura' },
                    { name: 'Alertas de farmacovigilancia AEMPS', href: '/actualidad', description: 'Seguridad de tratamientos óseos' }
                ]
            }
        ]
    },

    {
        ...
        colorType: 'green',
        accentColor: '#95BB0C',
        lightBg: 'bg-[#95BB0C]/10',
        borderColor: 'border-[#95BB0C]',
        textColor: 'text-[#95BB0C]',
        icon: HeartHandshake,
        featured: {
            title: 'Portal de salud ósea',
            desc: 'Información médica contrastada para pacientes y familias. Guías descargables, prevención de fracturas y hábitos saludables.',
            tag: 'Para el ciudadano',
            image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?q=80&w=600&auto=format&fit=crop',
            href: '/actualidad',
            ctaText: 'Aprender sobre salud ósea'
        },
        categories: [
            {
                title: 'Comprender la enfermedad',
                icon: Activity,
                links: [
                    { name: '¿Qué es la osteoporosis?', href: '/actualidad', description: 'Causas, síntomas y cómo afecta al esqueleto' },
                    { name: 'Densitometría y diagnóstico', href: '/actualidad', description: 'Cómo se detecta la pérdida de masa ósea' },
                    { name: 'Factores de riesgo', href: '/actualidad', description: 'Edad, genética, menopausia y hábitos' },
                    { name: 'Mitos y realidades del hueso', href: '/actualidad', description: 'Desmontando falsas creencias comunes' }
                ]
            },
            {
                ...
                icon: Apple,
                links: [
                    { name: 'Nutrición, calcio y vitamina D', href: '/actualidad', description: 'Alimentos y exposición solar adecuada' },
                    { name: 'Ejercicio para fortalecer huesos', href: '/actualidad', description: 'Fuerza, equilibrio y densidad mineral' },
                    { name: 'Prevención de caídas en el hogar', href: '/actualidad', description: 'Consejos prácticos para evitar fracturas' },
                    { name: 'Guías y folletos descargables', href: '/actualidad', isNew: false, description: 'Material didáctico para descargar e imprimir' }
                ]
            },
            {
                title: 'Tratamiento & apoyo',
                icon: HelpCircle,
                links: [
                    { name: 'Tratamientos y adherencia', href: '/actualidad', description: 'Por qué es clave no abandonar la pauta médica' },
                    { name: 'Preguntas frecuentes', href: '/actualidad', description: 'Respuestas de los especialistas de SEIOMM' },
                    { name: 'Asociaciones de pacientes', href: '/actualidad', description: 'Red de apoyo ciudadano (AECOSAR y más)' },
                    { name: 'Test de riesgo orientativo', href: '/actualidad', description: 'Cuestionario de factores de riesgo' }
                ]
            }
        ]
    }
...
export function NavBarAlt({ onSwitchToOriginal }: NavBarAltProps) {
    const [isScrolled, setIsScrolled] = useState(false);
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

    // Desktop active tab state for the mega menu dropdown
    const [activeTabId, setActiveTabId] = useState<'seiomm' | 'profesionales' | 'pacientes' | null>(null);

    // Mobile active tab selection inside mobile drawer
    const [mobileSelectedTab, setMobileSelectedTab] = useState<'seiomm' | 'profesionales' | 'pacientes'>('profesionales');
    ...
    const isDropdownOpen = activeTabId !== null;
    ...
    const activeTabConfig = navigationTabs.find(t => t.id === activeTabId);
    const mobileActiveTabConfig = navigationTabs.find(t => t.id === mobileSelectedTab) || navigationTabs[0];

    return (
        <header
            ref={menuContainerRef}
            onMouseLeave={handleMouseLeave}
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${effectiveIsScrolled
                ? 'bg-white/98 backdrop-blur-md shadow-sm border-b border-seiomm-dark/10'
                : 'bg-transparent border-transparent'
                }`}
        >
            {/* Main Bar with Tab Navigation */}
            <div
                className={`max-w-7xl mx-auto px-6 flex items-center justify-between transition-all duration-300 ${effectiveIsScrolled ? 'py-3.5' : 'py-5'
                    }`}
            >
                {/* Left: Logo */}
                <Link to="/" className="flex items-center gap-2 group shrink-0" aria-label="Ir al inicio SEIOMM">
                    <SeiommLogo effectiveIsScrolled={effectiveIsScrolled} />
                </Link>

                {/* Center: TAB-STYLE MAIN NAVIGATION (3 APARTADOS: SEIOMM, PROFESIONALES, PACIENTES) */}
                <nav
                ...
                >
                    ...
                    <div
                        className={`p-1 rounded-full flex items-center gap-1 transition-all duration-300 border ${effectiveIsScrolled
                            ? 'bg-seiomm-dark/3 border-seiomm-dark/20'
                    ...
                    >
                        {navigationTabs.map((tab) => {
                            ...
                            // Visual style based on the requested identity:
                            // - Profesionales: Blue (#01A0DA)
                            // - Pacientes: Green (#95BB0C)
                            // - Seiomm: Neutral/Dark slate
                            let tabClasses = '';

                            if (tab.id === 'profesionales') {
                                if (isActive) {
                                    tabClasses = 'bg-[#01A0DA] text-white';
                                } else if (effectiveIsScrolled) {
                                    tabClasses = 'text-seiomm-body hover:text-[#01A0DA] hover:bg-sky-50';
                                } else {
                                    tabClasses = 'text-white/80 hover:text-white hover:bg-sky-500/20';
                                }
                            } else if (tab.id === 'pacientes') {
                                if (isActive) {
                                    tabClasses = 'bg-[#95BB0C] text-white';
                                } else if (effectiveIsScrolled) {
                                    tabClasses = 'text-seiomm-body hover:text-[#7f9f0a] hover:bg-[#95BB0C]/10';
                                } else {
                                    tabClasses = 'text-white hover:text-white hover:bg-[#95BB0C]/20';
                                }
                            } else {
                                // Seiomm tab
                                if (isActive) {
                                    tabClasses = 'bg-seiomm-body text-white';
                                } else if (effectiveIsScrolled) {
                                    tabClasses = 'text-seiomm-body hover:text-seiomm-dark hover:bg-white';
                                } else {
                                    tabClasses = 'text-white/80 hover:text-white hover:bg-white/10';
                                }
                            }
                            ...
                            return (
                                <button
                                    ...
                                    className={`group relative flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 outline-none ${tabClasses}`}
                                >
                ...
                {/* Right side: Quick Highlights & Mobile Toggle */}
                <div className="flex items-center gap-3">
                    {/* CTA Buttons */}
                    <div className="hidden lg:flex items-center gap-4">
                        <Link
                            to="https://socios.seiomm.org/login"
                            className={`group link-underline flex items-center gap-1.5 rounded-full text-sm font-medium transition-colors ${effectiveIsScrolled
                                ? 'text-seiomm-body hover:text-seiomm-dark' : 'text-white/80 hover:text-white'}`} href="/" data-discover="true">
                            Área privada
                        ...
                        <Link
                            ...
                            target="_blank"
                            className={`px-6 py-2.5 rounded-full border text-sm font-medium transition-colors ${effectiveIsScrolled
                    ...
                    <button
                        className={`lg:hidden shrink-0 p-2 rounded-md ${effectiveIsScrolled
                            ? 'text-seiomm-dark hover:bg-zinc-100'
            ...
            {/* Desktop Mega Menu Dropdown for Active Tab */}
            <AnimatePresence>
                {isDropdownOpen && activeTabConfig && (
                    <motion.div
                        ...
                        className="hidden lg:block absolute top-full left-0 w-full bg-white border-t border-seiomm-dark/10 shadow-2xl overflow-hidden"
                    >
                        ...
                        <div
                            ...
                            style={{
                                backgroundColor:
                                    activeTabConfig.id === 'profesionales'
                                        ? '#01A0DA'
                                        : activeTabConfig.id === 'pacientes'
                                            ? '#95BB0C'
                                            : '#4A5567'
                            }}
                        />
                        ...
                        <div className="max-w-7xl mx-auto px-6 py-10">
                            ...
                            {/* 3 Categories columns + 1 Featured Card */}
                            <div className="grid grid-cols-12 gap-8">
                                {/* 3 Category Columns */}
                                <div className="col-span-8 grid grid-cols-3 gap-6">
                                    {activeTabConfig.categories.map((category, catIdx) => {
                                                ...
                                                <div className="flex flex-col gap-2.5 mt-1">
                                                    {category.links.map((link, linkIdx) => (
                                                        <Link
                                                            ...
                                                            onClick={closeMenus}
                                                            className="group block p-2 rounded-lg hover:bg-zinc-50 transition-colors"
                                                        >
                                                            <div className="flex items-center justify-between">
                                                                <span
                                                                    className={`text-sm font-medium transition-colors ${activeTabConfig.id === 'profesionales'
                                                                        ? 'text-seiomm-dark group-hover:text-[#01A0DA]'
                                                                        : activeTabConfig.id === 'pacientes'
                                                                            ? 'text-seiomm-dark group-hover:text-[#7f9f0a]'
                                                                            : 'text-seiomm-dark group-hover:text-seiomm-cyan'
                                                                        }`}
                                                                >
                                                                    {link.name}
                                                                </span>
                                                                {link.isExternal && (
                                                                    <ArrowUpRight className="w-3.5 h-3.5 text-seiomm-mute/60 group-hover:text-seiomm-dark" />
                                                                )}
                                                                {link.isNew && (
                                ...
                                <div className="col-span-4 border-l border-seiomm-8 pl-8">
                                    <div className="p-5 flex flex-col justify-between h-full">
                                        <div>
                                            ...
                                            <div className="relative aspect-[16/9] w-full overflow-hidden rounded-lg bg-zinc-200 mb-4">
                                                <img
                                                    src={activeTabConfig.featured.image}
                                                    alt={activeTabConfig.featured.title}
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="lg:hidden absolute top-full left-0 w-full bg-white shadow-2xl overflow-y-auto pb-10"
                    >
                        <div className="px-5 py-4 border-b border-zinc-100 bg-zinc-50">
                            {/* <p className="text-xs font-mono uppercase tracking-wider text-seiomm-mute mb-2">
                                Selecciona apartado:
                            </p> */}

                            {/* 3 Mobile Segmented Tabs */}
                            <div className="grid grid-cols-3 gap-1.5 p-1 bg-seiomm-dark/8 rounded-full">
                                {navigationTabs.map((tab) => {
                                    const isSelected = mobileSelectedTab === tab.id;
                                    let selectedClass = '';

                                    if (isSelected) {
                                        if (tab.id === 'profesionales') {
                                            selectedClass = 'bg-[#01A0DA] text-white font-semibold';
                                        } else if (tab.id === 'pacientes') {
                                            selectedClass = 'bg-[#95BB0C] text-white font-semibold';
                                        } else {
                                            selectedClass = 'bg-seiomm-body text-white font-semibold';
                                        }
                                    } else {
                                        selectedClass = 'text-seiomm-body hover:text-seiomm-dark bg-transparent';
                                    }

                                    return (
                                        <button
                                            key={tab.id}
                                            onClick={() => setMobileSelectedTab(tab.id)}
                                            className={`flex flex-col items-center justify-center py-2 px-1 rounded-full text-sm font-semibold transition-all ${selectedClass}`}
                                        >
                        ...
                        {/* Content for selected mobile tab */}
                        <div className="px-6 py-6">
                            {/* <div className="flex items-center gap-2 mb-4 pb-2 border-b border-zinc-100">
                                <span
                                    ...
                                    style={{
                                        backgroundColor:
                                            mobileActiveTabConfig.id === 'profesionales'
                                                ? '#01A0DA'
                                                : mobileActiveTabConfig.id === 'pacientes'
                                                    ? '#95BB0C'
                                                    : '#0A1220'
                                    }}
                                />
                                <h3 className="text-xl font-serif text-seiomm-dark">
                                    {mobileActiveTabConfig.name}
                                </h3>
                                <span
                                    className={`text-[10px] font-mono px-2 py-0.5 rounded-full font-medium ml-auto ${mobileActiveTabConfig.id === 'profesionales'
                                        ? 'bg-sky-100 text-[#01A0DA]'
                                        : mobileActiveTabConfig.id === 'pacientes'
                                            ? 'bg-[#95BB0C]/15 text-[#6c8709]'
                                            : 'bg-zinc-100 text-seiomm-dark'
                                        }`}
                                >
                                    {mobileActiveTabConfig.badge}
                                </span>
                            </div> */}

                            {/* Accordion Categories */}
                            <div className="flex flex-col divide-y divide-zinc-100">
                                {mobileActiveTabConfig.categories.map((category, idx) => (
                                    <div key={idx} className="py-3">
                                        <h4 className="font-mono text-seiomm-mute text-xs tracking-wide uppercase mb-2">
                                            {category.title}
                                        </h4>
                                        <div className="flex flex-col gap-2 pl-2">
                                            {category.links.map((link, lIdx) => (
                                                <Link
                                                    ...
                                                    target={link.isExternal ? '_blank' : undefined}
                                                    onClick={closeMenus}
                                                    className="py-1.5 text-sm font-medium text-seiomm-dark flex items-center justify-between active:text-seiomm-cyan"
                                                >
                                                    <span>{link.name}</span>
                                                    {link.isExternal && <ArrowUpRight className="w-3.5 h-3.5 text-zinc-400" />}
                                                </Link>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-zinc-200 flex flex-col gap-3">
                                <Link
                                    to="https://socios.seiomm.org/login"
                                    target="_blank"
                                    className={`flex items-center justify-center gap-2 px-5 py-3 mt-3 rounded-full border-2 text-base font-medium ${effectiveIsScrolled ? 'border-seiomm-dark/50 bg-white text-seiomm-body' : 'border-white/50 text-white/80'
                                        }`}
                                >
                                    Área privada
                                ...
                                <Link
                                    to="https://socios.seiomm.org/register"
                                    target="_blank"
                                    className={`flex items-center justify-center gap-2 px-5 py-3 mt-1 rounded-full border-2 border-transparent text-base font-medium  ${effectiveIsScrolled ? 'bg-seiomm-cyan text-white' : 'bg-white text-seiomm-dark'
                                        }`}
                                >
                                    Hazte socio
                                    <ArrowUpRight className="w-4 h-4" />
